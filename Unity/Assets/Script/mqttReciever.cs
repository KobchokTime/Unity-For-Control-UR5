...
public class mqttReceiver : M2MqttUnityClient
{
    ...
    public Button sendButton; // Reference to the button in the Unity editor

    protected override void Start()
    {
        base.Start();

        // Check if the sendButton is assigned
        if (sendButton == null)
        {
        ...
        sendButton.onClick.AddListener(SendMessageOnClick); // Add an event listener to the button
    }

    // Method to send a message when the button is clicked
